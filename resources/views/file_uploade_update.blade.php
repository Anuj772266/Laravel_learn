...
<body>
    <div class="container">
        <div class="row text-center">
            <div class="col-12">
                <h2 class=" mt-4">Update : File Upload</h2>
            </div>
        </div>
        <form action="{{ route('file-upload.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            {{-- @method('PUT') --}}
            <div class="row">
                <div class="col-3">
                    <img id="output" src="{{ asset('/storage/'.file-upload->file_name) }}" alt="">
                </div>
            </div>
            <div class="row text-center">
                <div class="col-9">
        ...
        {{-- <div class="row">
         ...
         <div class="row">
            ...
            <div class="col-2">
                ...
                <a href="" class="btn btn-warning btn-sm mb-3">Update</a>
            </div>
            @endforeach
